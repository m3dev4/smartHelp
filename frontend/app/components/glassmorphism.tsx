        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            >
              L'IA au service du
              <br />
              <span className="bg-linear-to-br from-white via-white to-[#ffcd75] bg-clip-text text-transparent">support client</span>
            </h1>

            {/* Description */}
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              Analysez automatiquement les réclamations grâce à l'intelligence artificielle. SmartHelp transcrit les messages vocaux,
              détecte les anomalies sur les produits, applique les règles internes via le RAG et propose un statut pour chaque ticket.
            </p>
